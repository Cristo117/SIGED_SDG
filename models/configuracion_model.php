 ...
 */
function configuracion_model_asegurarConfiguracionInicial($conn) {
 ...
 */
function configuracion_model_obtenerValorAfiliacion($conn) {
 ...
 */
function configuracion_model_guardarValorAfiliacion($conn, $valor) {
